        ...
        <div className="mb-5 flex flex-col items-center justify-center">
            <div className="container max-w-screen-xl border-[3px] border-gray-600 rounded-lg px-6 py-10 flex flex-col items-center justify-center mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between  items-center space-y-8 md:space-y-0 md:space-x-6 w-full h-full min-h-[400px]">
                    {/* Section One */}
                    <div className="bg-gray-800 sm:p-6 p-3 border-gray-500 border rounded-lg shadow-lg flex-1 flex items-center justify-center w-full h-[455px]">
                        <div className="w-full h-full flex flex-col justify-cente items-centerr">

                            <motion.div

                                initial={{ y: -25,opacity:0.2  }} animate={{ y: 0,opacity:1 }} transition={{ duration: "3", delay: "2" }}
                            ...
                            <div className="flex space-x-6 my-5 h-2/4 items-center justify-center">
                                <motion.a
                                    initial={{ x: -25 ,opacity:0.2 }} animate={{ x: 0 ,opacity:1 }} transition={{ duration: "3", delay: "2" }}
                                    target="_blank"
                                ...
                                <motion.a
                                 initial={{y:0,opacity:0.2 }} animate={{y:0,opacity:1, rotate: 360 }} transition={{duration:"3", delay:"2"}}
                                    target="_blank"
                                    rel="noopener noreferrer"
                    ...
                    {/* Section Two */}
                    <div className="bg-gray-800 sm:p-6 p-3 border border-gray-500 rounded-lg shadow-lg flex-1 flex flex-col justify-between w-full h-full">
